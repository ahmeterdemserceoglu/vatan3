...
export async function signInWithGoogle(): Promise<User | void> {
    ...
    // Check if inside Capacitor app (WebView) - popup works better there
    const isCapacitor = typeof (window as any).Capacitor !== 'undefined';

    // Check for mobile browser (not Capacitor)
    ...
    try {
        console.log('SignIn - isCapacitor:', isCapacitor, 'isMobileBrowser:', isMobileBrowser);
        ...
        if (isMobileBrowser || popupError.code === 'auth/popup-blocked') {
